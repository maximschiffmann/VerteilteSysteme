package Uebung3ThreadpoolWebserver;
...
public class RequestHandler implements Runnable {
	...
	public void run() {
		...
		try {
			...
			String request = reader.readLine(); // GET index.html HTTP/1.1
			...
			List<String> linesInFile = Files.readAllLines(Paths.get("./src/Uebung3ThreadpoolWebserver/" + fileName));
			...
			writer.println();
			writer.println("Fehler 404: Datein nicht gefunden!");
			writer.flush();
			writer.close();
